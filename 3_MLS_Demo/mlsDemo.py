# -*- coding: utf-8 -*-
"""
Created on Sat Nov 15 10:49:14 2018
...
from mlsDemo_utils import *
#(mls_affine_deformation, mls_affine_deformation_inv,
...
def demo(fun, fun_inv, name):
    ...
    image = plt.imread(os.path.join(sys.path[0], "./data/biscuit.jpg"))
    #image = plt.imread(os.path.join(sys.path[0], "monalisa.jpg"))
    #image = plt.imread(os.path.join(sys.path[0], "bbh.jpg"))
...
def demo2(fun):
    ...
    image = plt.imread(os.path.join(sys.path[0], "./data/monalisa.jpg"))
    #image = plt.imread(os.path.join(sys.path[0], "bbh.jpg"))
    plt.subplot(121)
    plt.axis('off')
    plt.imshow(image)
